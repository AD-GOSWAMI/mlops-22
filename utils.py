...
def test_bias(clf,x_test, y_test):
    ...
    if n_class_prediction == 1 and n_class_test!=1:
        print("This is a Biased Model")
        return 0 
    else:
        print("This is a Unbiased Model")
        return 1

def test_class(clf,x_test, y_test):
    ...
    if n_class_prediction ==  n_class_test:
        print("This Model predicts all classes")
        return 1 
    else:
        print("This Model  do not predicts all classes")
        return 0
